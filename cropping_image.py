...
def get_image(file_name_string):
    raw_img = cv.imread(file_name_string)
    return raw_img


def main(file_name_string):

    # raw_img = cv.imread(r'C:\Users\DARPAN\Documents\College\6th Semester\BSc Project (DSE6)\Data\302_0020.png')

    raw_img = get_image(file_name_string)
